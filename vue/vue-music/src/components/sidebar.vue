<template>
  <div class="sidebar"  :class="{showSidebar: showSidebar}">
      <div class="sidebar-con" :class="{showbar: showSidebar}">
          <div class="head">
              <div class="avatar">
                  <img src="https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=39618899,3237356509&fm=26&gp=0.jpg" alt="">
              </div>
              <div class="name">
                  蜗牛
              </div>
      ...
      <div v-show="showSidebar" class="sidebar_mask"  @click="hideSidebar"></div>
  </div>
</template>
